...
def mlflow_log_pyplot(fig: plt.Figure, artifact_path: str, local_path: str) -> None:
    """
    Save a matplotlib.pyplot figure in a temporary directory.
    Log the temporary directory within the mlflow current run.
    ...
    mlflow.log_artifact(local_path=file_path, artifact_path=artifact_path)
    logger.info(f'mlflow_log_plt_figure: {local_path}')